...
#define IR_RECEIVE_PIN      4  // GPIO15 to be compatible with the Arduino Nano RP2040 Connect (pin3)
#define IR_SEND_PIN         16  // GPIO16
#define TONE_PIN            15
#define APPLICATION_PIN     11
#define ALTERNATIVE_IR_FEEDBACK_LED_PIN 2 // E.g. used for examples which use LED_BUILDIN for example output.
#define _IR_TIMING_TEST_PIN 3
